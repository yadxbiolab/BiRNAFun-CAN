...
if __name__ == "__main__":
    # 输入FASTA文件路径
    fasta_file_path = "/home/baona/tiaocan/BiRNAFun-CAN/data/test-.fasta"
    ...
    pd.DataFrame(predicted_scores, columns=['Predicted Scores']).to_csv('predicted_scores.csv', index=False)
